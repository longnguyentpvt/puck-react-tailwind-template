...
import { AutoField, Button, createUsePuck, FieldLabel, walkTree, ComponentConfig, ComponentDataOptionalId, Slot } from "@measured/puck";
          ...
          await createComponent("Grid", {
            ...
            items: [
              await createComponent("Card", { 
                ...
                showHeader: true,
                header: [
                  await createComponent("Heading", { text: "A card", size: "l" }),
                ],
              }),
